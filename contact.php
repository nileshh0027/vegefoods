      ...
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Address:</span>  Applewood Complex, Sasan Road, Mendarda </p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Phone:</span> <a href="">+91 987654321</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="">vegefoods@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
...
<?php
			if(isset($_POST['submit']))
			{
				...
				$query = "insert into user_feedback(u_name,u_email,subject,message) values('$u_name','$u_email','$subject','$msg')";
